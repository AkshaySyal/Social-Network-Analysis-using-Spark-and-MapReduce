...
Optional: Use Dockerfile instead of installing the libraries

Dockerhub registration: https://hub.docker.com/

Installing Docker on Windows 10/11 with WSL https://learn.microsoft.com/en-us/windows/wsl/install https://docs.docker.com/desktop/install/windows-install/

Installing Docker on MacOS https://www.docker.com/products/docker-desktop/
...
7) AWS EMR Hadoop: (you must configure the emr.* config parameters at top of Makefile)
   From your local machine (assuming aws-cli is installed)
   	- `aws configure` -- then enter your access ID and secret from learner's lab) -> creates credentials and config in ~/.aws
   	- `Manually enter session ID in credentials`
